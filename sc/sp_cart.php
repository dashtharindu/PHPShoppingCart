...
<!--Created by Tharindu-D -->
<tr>
<td colspan="3"><font color="red"><big><b>Now choose your <?php echo $sp ; ?> specials....</b></big></font></td>
</tr>
<tr>
<td colspan="3">
	<table id="tb_back">
	...
	<tr>
	<td><div id="btn_back"><form method='post'><input type='submit' name="back" value='<< Back to Specials'></form></div><br/>&nbsp;</td>
    <td><div id="btn_back"><form method='post'><input type='submit' name="all" value='View All Meals >>'></form></div><br/>&nbsp;</td>
	</tr>
	</table>
</td>
</tr>
...
<div style="float : left ; width : 67% ;">
	...
	$results = $mysqli->query("SELECT * FROM `rest` WHERE sp ='".$sp."'");
